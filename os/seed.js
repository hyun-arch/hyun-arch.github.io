...
window.AHOS_SEEDREV = 2; // 시드 내용 늘릴 때마다 +1 (기존 사용자 데이터 보존한 채 신규만 추가)
...
window.SEED_PEOPLE = [
  ...
  P({id:'p_prod', name:'한생산', role:'생산 팀장', dept:'생산', team:'생산', manager:'p_ceo', location:'수원', start:'2015-04-06',
     skills:['진단기기 양산','공정관리','품질'], ask:'생산 · 납기 · 원가', bio:'진단기기 양산 라인과 출하 품질을 책임진다.',
     believe:{제품:6, 전략:5, 마케팅:2, 생산:8, 재무:5, 인사:4}, birthday:'07-22' }),
  P({id:'p_mgmt', name:'서경영', role:'경영지원 팀장', dept:'경영', team:'경영지원', manager:'p_ceo', location:'서울', start:'2017-08-21',
     skills:['인사','재무','총무·제도'], ask:'채용 · 재무 · 사내제도', bio:'사람과 프로세스가 성장 속도를 따라가게 만든다.',
     believe:{제품:3, 전략:6, 마케팅:4, 생산:4, 재무:8, 인사:9} }),
  P({id:'p_rnd2', name:'김선임', role:'선임연구원', dept:'R&D', team:'R&D', manager:'p_rnd', location:'서울', start:'2020-03-16',
     skills:['영상처리','머신러닝'], ask:'진단 알고리즘 · ML', bio:'진단 정확도 개선 담당.',
     believe:{제품:7, 전략:4, 마케팅:2, 생산:4, 재무:3, 인사:3} }),
  P({id:'p_prod2', name:'조공정', role:'공정담당', dept:'생산', team:'생산', manager:'p_prod', location:'수원', start:'2021-06-01',
     skills:['공정 셋업','설비'], ask:'양산 공정 · 설비', bio:'양산 공정 셋업과 설비 관리.',
     believe:{제품:5, 전략:3, 마케팅:2, 생산:7, 재무:3, 인사:3} }),
];
...
window.SEED_OKRS = [
  ...
  { id:'o_prod', level:'부서', dept:'생산', owner:'p_prod', cycle:'2026 H2', parent:'o_co',
    objective:'진단기기 품질과 납기를 동시에 지킨다', status:'ontrack',
    krs:[ KR('출하 불량률(DOA)','%',1.2,0.7,0.3), KR('정시 납기율','%',90,94,98), KR('생산 원가 절감','%',0,2,5) ] },
  { id:'o_mgmt', level:'부서', dept:'경영', owner:'p_mgmt', cycle:'2026 H2', parent:'o_co',
    objective:'사람과 프로세스가 성장 속도를 못 따라가지 않게 한다', status:'risk',
    krs:[ KR('채용 리드타임','일',45,38,30), KR('eNPS','점',20,28,40), KR('핵심 SOP 문서화율','%',40,65,90) ] },
];
...
window.SEED_DECISIONS = [
  ...
  { id:'d4', title:'차세대 진단기, 정확도 완성도 우선 vs 출시 속도 우선?', domain:'제품',
    valueKey:'v1', proposer:'p_rnd', reversibility:'one', status:'proposed',
    context:'차세대 진단기 출시 시점. 정확도 94% 목표까지 더 파느냐, 91%로 먼저 출시하느냐.',
    options:['정확도 94% 달성 후 출시(완성도)','91%로 조기 출시(속도)','핵심 시장만 조기, 나머지 후속'],
    evidence:'진단은 본질(V1)이 정확도. 오진 리스크는 브랜드 신뢰를 크게 훼손. 단, 경쟁사 신제품이 6개월 내 예상.',
    votes:[ VOTE('p_rnd','정확도 94% 달성 후 출시(완성도)','오진 1건 손실 > 출시 6개월 지연'),
            VOTE('p_rnd2','정확도 94% 달성 후 출시(완성도)','91%는 특정 피부톤에서 오차 큼'),
            VOTE('p_mkt','91%로 조기 출시(속도)','경쟁사 선점 리스크'),
            VOTE('p_ceo','핵심 시장만 조기, 나머지 후속','둘 다 잡는 절충') ],
    chosen:'', decidedBy:'', dissent:'', expected:'', confidence:0, reviewDate:'', createdAt: iso(-30) },
  { id:'d5', title:'주 4일 근무 파일럿을 도입할까?', domain:'인사',
    valueKey:'v4', proposer:'p_mgmt', reversibility:'two', status:'proposed',
    context:'번아웃·채용 경쟁력 이슈. 한 팀 대상 3개월 주 4일 파일럿 제안.',
    options:['한 팀 3개월 파일럿','전사 즉시 도입','현행 유지'],
    evidence:'사람이 목적(V4). 채용 리드타임 개선·몰입도 향상 기대. 파일럿으로 생산성 영향 측정 후 확대 판단.',
    votes:[ VOTE('p_mgmt','한 팀 3개월 파일럿','되돌릴 수 있게 작게 실험(two-way door)'),
            VOTE('p_ceo','한 팀 3개월 파일럿','데이터로 보고 결정') ],
    chosen:'', decidedBy:'', dissent:'', expected:'', confidence:0, reviewDate:'', createdAt: iso(-12) },
];
...
window.SEED_SOP_TEMPLATES = [
  ...
  { id:'sop_dealer', name:'신규 해외 대리점 온보딩', dept:'마케팅', owner:'p_mkt',
    desc:'계약 승인 → 제품 교육 → 데모기 발송 → 마케팅 자산 제공 → 첫 주문.',
    steps:[ STEP('대리점 계약 검토','표준','p_mkt'), STEP('계약 승인','승인','p_ceo',{stop:true}),
            STEP('제품·진단 교육','표준','p_mkt'), STEP('데모기 발송','표준','p_prod',{field:'시리얼/송장'}),
            STEP('마케팅 자산 제공','표준','p_mkt'), STEP('첫 주문 접수','표준','p_mkt') ] },
  { id:'sop_close', name:'월 마감', dept:'경영', owner:'p_mgmt',
    desc:'매출·매입 마감 → 재고 실사 대조 → 결산 → 승인.',
    steps:[ STEP('매출·매입 마감','표준','p_mgmt'), STEP('재고 실사 대조','표준','p_pur'),
            STEP('결산 작성','표준','p_mgmt'), STEP('결산 승인','승인','p_ceo',{stop:true}) ] },
  { id:'sop_npd', name:'신제품 개발 게이트', dept:'R&D', owner:'p_rnd',
    desc:'컨셉 → 설계 → 시제품 → DVT → 개발 승인(게이트) → 양산 이관.',
    steps:[ STEP('컨셉 정의','표준','p_rnd'), STEP('설계','표준','p_rnd2'), STEP('시제품 제작','표준','p_rnd2'),
            STEP('DVT (설계 검증)','게이트','p_rnd',{stop:true, field:'검증 리포트'}),
            STEP('개발 승인','승인','p_ceo',{stop:true}), STEP('양산 이관','표준','p_prod') ] },
];
